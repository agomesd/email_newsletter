...
#[tokio::test]
async fn subrscribe_returns_200_for_valid_form_data() {
    // Arrange
    let address = spawn_app();
    ...
    // Act
    let body: &str = "name=alex&email=alex.gduguay%40gmail.com";
    ...
    assert_eq!(saved.email, "alex.gduguay@gmail.com");
...
async fn subscribe_returns_a_400_when_data_is_missing() {
    ...
    let client = reqwest::Client::new();
    let test_cases = vec![
        ("name=alex", "missing the email"),
        ("email=alex.gduguay%40gmail.com", "missing the name"),
